         ...
         return(  <div className="mainContener">
            ...
            <div className="regsucces">
                <div className="regSuccesInfo">
                    <h2>GRATULACJE {userName.toUpperCase()}, UDAŁO SIĘ ZAREJESTROWAĆ, TERAZ MOŻESZ SIĘ JUŻ ZALOGOWAĆ</h2>
                </div>
                <div className="regsuccesBtn">
                    <button onClick={() => exitReg()} className="btn" type="button">WRÓĆ DO LOGOWANIA</button>
                </div>
            </div>  
                ...
                <div className="content">
                    ...
                    <div className="footer">
                        <button onClick={()=>checkValid()} type="button" className="btn">REJESTRACJA</button>
                        <button onClick={()=>exitReg()} type="button" className="btn">ZAMKNIJ</button>
                    </div>
